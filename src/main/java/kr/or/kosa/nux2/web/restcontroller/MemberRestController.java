...
public class MemberRestController {
    ...
    @PostMapping("/email")
    public ResponseEntity<ApiResponse<MemberDto.CheckMemberIdResponse>> checkMemberIdAuthentication(@Valid @RequestBody MemberDto.MemberIdRequest request) {
    ...
    public ResponseEntity<ApiResponse<MemberDto.CheckAuthenticationNumberResponse>> checkAuthenticationNumber(@Valid @RequestBody MemberDto.AuthenticationRequest request) {
    ...
    public ResponseEntity<ApiResponse<MemberDto.ProfileResponse>> editMemberInfo(@Valid @RequestBody MemberDto.UpdateMemberInfoRequest request) {
